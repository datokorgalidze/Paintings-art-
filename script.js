...
/* harmony import */ var _modules_showCards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showCards */ "./src/js/modules/showCards.js");
/* harmony import */ var _modules_calc__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calc */ "./src/js/modules/calc.js");
/* harmony import */ var _modules_tabFilter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tabFilter */ "./src/js/modules/tabFilter.js");
/* harmony import */ var _modules_picturesOnMouse__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/picturesOnMouse */ "./src/js/modules/picturesOnMouse.js");
...
/* harmony import */ var _modules_dragdrop__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/dragdrop */ "./src/js/modules/dragdrop.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_showCards__WEBPACK_IMPORTED_MODULE_3__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_tabFilter__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_picturesOnMouse__WEBPACK_IMPORTED_MODULE_6__["default"])('.sizes-block');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_7__["default"])('.accordion-heading');
  Object(_modules_burgermenu__WEBPACK_IMPORTED_MODULE_8__["default"])('.burger-menu', '.burger', '.burger-close');
  Object(_modules_dragdrop__WEBPACK_IMPORTED_MODULE_9__["default"])();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const accordion = selectorTriggers => {
...
const modals = () => {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      document.querySelectorAll('[data-modal]').forEach(item => {
        if (getComputedStyle(item).display !== 'none') display = 'block';
      });
  ...
  showModalByTime('.popup-consultation', 60000); //   modalBind('.burger',  '.burger-menu', '.burger-menu .popup-close');     
};
...
/***/ "./src/js/modules/picturesOnMouse.js":
/*!*******************************************!*\
  !*** ./src/js/modules/picturesOnMouse.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (pictursOnMouse);
...
const showCards = (trigger, wrraper) => {
  ...
  btn.addEventListener('click', function () {
    getData('assets/db.json').then(res => creatCards(res.styles)).catch(error => console.log(error));
    this.remove();
  });
  ...
  function activatedSlider() {
    if (direc === 'vertical') {
      paused = setInterval(function () {
        changeSlides(1); // items[sliderIndex - 1].classList.add('slideInDown');
...
/* harmony default export */ __webpack_exports__["default"] = (tabFilter);
